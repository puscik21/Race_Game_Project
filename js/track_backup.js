...
Track.prototype.loadTrack = function(selectedTrack){
	...
	if(selectedTrack == "Mountain") {
	loader.load( 'models/gltf/MountainValley_Track.glb', function( track, track_materials ) {
			var mat = Physijs.createMaterial(
			new THREE.MeshLambertMaterial({ color: 0xffffff, opacity: 0.5, transparent: true }),
				.9, // friction
				.3 // restitution
			);
			raceTrack = new Physijs.BoxMesh(
				track,
				mat,
				0 //mass
			);
		...
		loader.load( 'models/gltf/Mountain_Street.glb', function ( track, track_materials ) {
			var raceStreet = new Physijs.PlaneMesh(
				track,
			    mat,
				0 //mass
